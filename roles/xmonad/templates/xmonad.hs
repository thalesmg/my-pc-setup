...
myMiscKeys conf@XConfig{modMask = modm} = M.fromList $
  ...
  , ((0, xK_Print), spawn "{{ home }}/bin/take-screenshot.sh")
  ...
  , ((modm .|. controlMask, xK_KP_Multiply), spawn "{{ home }}/bin/tmg-vlc.sh next")
  , ((0, xF86XK_AudioNext), spawn "{{ home }}/bin/tmg-vlc.sh next")
  , ((modm .|. controlMask, xK_KP_Divide), spawn "{{ home }}/bin/tmg-vlc.sh previous")
